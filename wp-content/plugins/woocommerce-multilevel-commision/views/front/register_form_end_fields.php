...
?>
        <p class="form-row form-row-wide">
	        <label for="option_1"><input type="radio" id="option_1" name="join_referral_program" <?php echo isset($data['join_referral_program']) && $data['join_referral_program'] == "1" ? 'checked' : ''; ?> value="1" /> <?php echo __( 'I have the referral code and want to join referral program.', 'wmc' ); ?></label>
	        <label for="option_2"><input type="radio" id="option_2" name="join_referral_program" <?php echo isset($data['join_referral_program']) && $data['join_referral_program'] == "2" ? 'checked' : ''; ?> value="2" /> <?php echo __( 'I don\'t have referral code or I lost it. But I wish to join referral program.', 'wmc' ); ?></label>
	        <label for="option_3"><input type="radio" id="option_3" name="join_referral_program" <?php echo isset($data['join_referral_program']) && ($data['join_referral_program'] == 0 || $data['join_referral_program']) == "3" ? 'checked' : ''; ?> value="3"  /> <?php echo __('No, I don\'t want to be a part of referral program at this time.', 'wmc' ); ?></label>	
        </p>
        ...
        <p class="referral_code_panel form-row form-row-wide hide">
