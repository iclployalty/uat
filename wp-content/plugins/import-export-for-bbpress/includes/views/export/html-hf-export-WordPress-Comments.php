<div class="tool-box">
    ...
    <p><?php _e('Export and download your Forums and Topics, Replies in CSV format. This file can be used to import Forums, Topics, Replies back into your shop.', 'hf_bb_import_export'); ?></p>
    <form action="<?php echo admin_url('admin.php?page=HF_BB_CSV_IM_EX&action=export'); ?>" method="post">
        ...
        <table class="form-table">
            ...
            <div id='p_woodis_body'>
                    ...
                    <p style="font-size: 12px"><?php _e('topics and replys under these Forums will be exported.', 'hf_bb_import_export'); ?></p>
            </div>  
                    <br>
                     <input type="checkbox"  id="bb_tt_enable"  name="bb_tt_enable[]" value="1"  /><?php _e('with Reply', 'hf_bb_import_export'); ?>
