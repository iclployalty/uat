                ...
                <?php if ( woocommerce_product_loop() ) : ?>
                    ...
                    <?php if (function_exists('woocommerce_get_loop_display_mode')):?>
                        ...
                        <?php if ( 'subcategories' === $display_type || 'both' === $display_type ):?>
                            <?php woocommerce_output_product_categories(array( 'before' => '<div class="col_wrap_fifth rh-flex-eq-height products_category_box column_woo">', 'after' => '</div>', 'parent_id' => is_product_category() ? get_queried_object_id() : 0)); ?>
                        <?php endif; ?>
                    <?php endif; ?>
