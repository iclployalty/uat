...
return array(
			...
			array(
				...
				'fields' => array(	
					...
					array(
						...
						'label' => __('Add custom content to top line', 'rehub_framework'),
					),																					
				),
			),											
		),
		...
		'controls' => array(
			array(
				...
				'fields' => array(
					...
					array(
						'type' => 'color',
						'name' => 'fullfooter_color_background',
	...
	array(
		...
		'controls' => array(
			...
			array(
				'type' => 'section',
				'title' => __('Mobile Sliding panel', 'rehub_framework'),
				'fields' => array(	
					array(
						'type' => 'upload',
						'name' => 'logo_mobilesliding',
						'label' => __('Enable logo in sliding mobile panel', 'rehub_framework'),			
					),	
					array(
						'type' => 'upload',
						'name' => 'bg_mobilesliding',
						'label' => __('Enable background under logo', 'rehub_framework'),			
					),
					array(
						'type' => 'color',
						'name' => 'color_mobilesliding',
						'label' => __('Background color under logo', 'rehub_framework'),	
						'format' => 'hex',							
					),						
					array(
						'type' => 'textarea',
						'name' => 'text_mobilesliding',
						'label' => __('Add custom element or shortcode', 'rehub_framework'),
					),														
				),
			),			
			array(
			...
			array(
				...
				'fields' => array(
					array(
						...
						'label' => __('Enable Inner Storage of Google Fonts', 'rehub_framework'),
						'description' => 'Read how to use Inner Storage for Google Fonts <a href=" http://rehubdocs.wpsoul.com/docs/rehub-theme/how-to/local-google-fonts-for-gdpr/" target="_blank">in tutorial</a>',
						'default' => '0',
					),										
				),
			),				
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'label' => __('Wishlist Button Support for Cache plugins', 'rehub_framework'),
						'default' => '0',
					),										
					array(
						'type' => 'toggle',
			...
			array(
				...
				'fields' => array(
					...
					array(
						...
						'label' => __('Terms and conditions page url for popup', 'rehub_framework'),
					),
					array(
						'type' => 'textbox',
						'name' => 'userlogin_policy_page',
						'label' => __('Privacy Policy page url for popup', 'rehub_framework'),
					),						
					array(
						'type' => 'textbox',
						'name' => 'userlogin_submit_page',
						'label' => __('Select url for post submit form', 'rehub_framework'),						
					),	
					array(
						'type' => 'textbox',
						'name' => 'userlogin_submit_page_label',
						'label' => __('Select label for post submit form', 'rehub_framework'),						
					),						
					array(
						'type' => 'textbox',
						'name' => 'userlogin_edit_page',
						'label' => __('Select url for post edit form', 'rehub_framework'),			
					),
					array(
						'type' => 'textbox',
						'name' => 'userlogin_edit_page_label',
						'label' => __('Select label for post edit form', 'rehub_framework'),			
					),														
					array(
						'type' => 'toggle',
	...
	array(
		...
		'controls' => array(				
			array(
				'type' => 'section',
				'title' => __('General settings', 'rehub_framework'),
				'fields' => array(
					array(
						'type' => 'notebox',
						'name' => 'rehub_favicon_note',
			...
			array(
				...
				'fields' => array(
					...
					array(
						'type' => 'toggle',
						'name' => 'woo_aff_btn',
						'label' => __('Enable affiliate links instead inner?', 'rehub_framework'),
						'default' => '0',
					),										
					array(
						'type' => 'toggle',
					...
					array(
						'type' => 'toggle',
						'name' => 'woo_helpornot',
						'label' => __('Enable Help or not Buttons in reviews?', 'rehub_framework'),
						'default' => '0',
					),																			
				),
			),	
