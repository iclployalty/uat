...
<div class="wrap about-wrap rehub-wrap">
	...
	<?php if( $registeredlicense == true ) :?>
		<p class="about-description">
			You can use fast demo clones from this page. Difference between demo clones and demo import is that Clones will <strong style="color:red; font-size: 16px">overwrite your whole site and delete your existed content</strong>. We recommend to use Demo import, however, in some cases demo clones are good alternative. <br /><br />
				...
				foreach ( $demos as $demo => $demo_details ) { ?>
					<div class="theme">
						...
						<div id="linkdemo-<?php echo esc_attr($demo); ?>" style="display:none;">
	     					<p><?php echo wp_kses_post($demo_details['zip']); ?></p>
						</div>
