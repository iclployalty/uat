			...
			<div class="theme <?php echo esc_attr($class); ?>">
				<div class="theme-screenshot">
					...
					<?php if( isset( $installed_plugins[$plugin['file_path']] ) ): ?>
						<?php printf('%s %s | <a href="%s" target="_blank">%s</a>', __( 'Version:', 'rehub_framework' ), $installed_plugins[$plugin['file_path']]['Version'], $installed_plugins[$plugin['file_path']]['AuthorURI'], $installed_plugins[$plugin['file_path']]['Author'] ); ?>
					<?php elseif ( $plugin['source_type'] == 'bundled' ) : ?>
						<?php printf('%s %s', __( 'Available Version:', 'rehub_framework' ), $plugin['version'] ); ?>					
					<?php endif; ?>
					</div>
				</div>
				<h3 class="theme-name">
					...
					if( $plugin_status == 'active' ) {
						printf( '<span>%s</span> ', __( 'Active:', 'rehub_framework' ) );
					}
