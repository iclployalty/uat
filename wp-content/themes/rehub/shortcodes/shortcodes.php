...
if (is_user_logged_in()) {
    ...
    $output .= '<ul class="user-dropdown-intop-menu">';
        ...
        if ($submit_url) :
        	...
        	if(!$submit_url_label){
        		$submit_url_label = __("Submit a Post", "rehub_framework");
        	}
        ...
        if ($edit_url) :
        	...
        	if(!$edit_url_label){
        		$edit_url_label = __("Edit My Posts", "rehub_framework");
        	}        	     	
...
function wpsm_tax_archive_shortcode( $atts, $content = null ) {
	...
	$args = array( 'hide_empty' => true, 'order' => 'ASC', 'taxonomy'=> $taxonomy, 'number'=> $number, 'child_of' => $child_of);
