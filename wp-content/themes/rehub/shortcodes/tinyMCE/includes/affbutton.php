...
<div class="affbtn">
	...
	<p>
		<label><?php _e('Enable timer?', 'rehub_framework') ;?></label>
        <input id="timer" name="timer" type="checkbox" class="checks" value="false" />
        <small><?php _e('You can leave all fields blank and enable this field if you want to show button from Main offer of post and timer based on expiration date', 'rehub_framework') ;?></small>        
	</p>
	<div class="clear"></div>
</div>
	 <p>
