...
function getHotLike( $post_id ) {
    ...
    if ( AlreadyHot( $post_id ) ) { // already liked, set up unlike addon
        ...
        $output .= '<button class="hotminus'.$onlyuser_class.'"'.$loginurl.' alt="'.__('Vote down', 'rehub_framework').'" title="'.__('Vote down', 'rehub_framework').'" data-post_id="'.$post_id.'" data-informer="'.$temp.'"></button>';
    }
    ...
    if ( AlreadyHot( $post_id ) ) { // already liked, set up unlike addon
        ...
        $output .= '<button class="hotplus'.$onlyuser_class.'"'.$loginurl.' alt="'.__('Vote up', 'rehub_framework').'" title="'.__('Vote up', 'rehub_framework').'" data-post_id="'.$post_id.'" data-informer="'.$temp.'"></button>';
    }
    $output .= '</span>';
    ...
    $output .= '<span class="table_cell_thumbs">';
        if ($onlyone == false) {
            if ( AlreadyHot( $post_id ) ) { // already liked, set up unlike addon
                ...
                $output .= '<span class="thumbminus'.$onlyuser_class.'"'.$loginurl.' title="'.__('Vote down', 'rehub_framework').'" data-post_id="'.$post_id.'" data-informer="'.$temp.'">'.$outputtext.'</span>';
            }
        }    
        if ( AlreadyHot( $post_id ) ) { // already liked, set up unlike addon
            ...
            $output .= '<span class="thumbplus'.$onlyheartclass.$onlyuser_class.'"'.$loginurl.' data-post_id="'.$post_id.'" data-informer="'.$temp.'">'.$outputtext.'</span>';
        }   
    $output .= '</span>';
    if ($deal_score == false) {
        $output .= '<span id="thumbscount'.$post_id.'" class="thumbscount';
