    ...
    if (!function_exists('rehub_postview_enqueue')){
        function rehub_postview_enqueue() {
            ...
            if ( is_single() ) {     
                ...
                wp_localize_script( 'rehub-postview', 'postviewvar', array('rhpost_ajax_url' => get_template_directory_uri() . '/functions/rehub_ajax.php', 'post_id' => intval($post->ID)));
...
//////////////////////////////////////////////////////////////////
if (rehub_option('wish_cache_enabled')) {
    ...
    if (!function_exists('re_wish_cache_enabled')){
        function re_wish_cache_enabled() {
            ...
            wp_localize_script( 'rehub', 'wishcached', array('rh_ajax_url' => get_template_directory_uri() . '/functions/rehub_ajax.php', 'userid' => $user_id)); 
        } 
    } 
}
...
function rehub_ajax_search() {
    ...
    if (count($search_query->posts) == 0) {
        ...
        $buffer_msg .= '<div class="re-aj-search-result-msg"><a href="' . esc_url(home_url('/?s=' . $re_string.'&post_type='.$posttypes.''.$product_cat )) .'">' . __('View all results', 'rehub_framework') . '</a></div>';
        //add wrap
