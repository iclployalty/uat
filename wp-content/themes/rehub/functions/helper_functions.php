...
function rh_import_tables_from_json( $db_table = '', $path_to_json_file = '' ) {
  ...
  if( !empty( $db_table ) ){
    ...
    if( $path_to_json_file ) {
      $json_data = json_decode( file_get_contents( $path_to_json_file ), true );
