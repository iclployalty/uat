        ...
        return array(
            ...
            array(
                ...
                "value" => array(
                    ...
                    __('Recent viewed products', 'rehub_framework') => "recentviews",                                
                ), 
                'dependency' => array(
                    'element' => 'data_source',
                    'value' => array( 'type' ),
...
vc_add_param("small_thumb_loop", 
    array(
        ...
        "value" => array(
            ...
            __('No border Magazine style', 'rehub_framework') => "2",                 
        ),
    )
);
...
vc_add_params("columngrid_loop", array(
    ...
    array(
        "type" => "checkbox",
        "class" => "",
        "heading" => __('Disable price meta?', 'rehub_framework'),
        "value" => array(__("Yes", "rehub_framework") => true ),
...
vc_map( array(
    ...
    "params" => array(  
        ...
        array(
            "type" => "textfield",
            "heading" => __('Category ID or slug:', 'rehub_framework'),
            "param_name" => "category",
            'description' => __('Place ID of category. You can use also Category slug, but in this case you must add taxonomy slug, for example, product_cat is slug for woocommerce categories, category is slug for posts categories. ', 'rehub_framework'),
        ),
        array(
            "type" => "textfield",
            "heading" => __('Taxonomy slug', 'rehub_framework'),
            "param_name" => "taxslug",
            'description' => __('Leave blank if you use Category ID', 'rehub_framework'),            
        ),                                                       
...
vc_map( array(
    ...
    'params' => array(
        ...
        array(
            'type' => 'checkbox',
            'class' => '',
            'heading' => __('Open in the same window?', 'rehub_framework'),
            'value' => array(__('Yes', 'rehub_framework') => true ),
