				...
				<div class="tabledisplay">
		    		...
		    		<div id="wcvendor_profile_act_desc" class="wcvendor_profile_cell">
							...
							<?php if ( $verified_vendor ) : ?>
								<?php 				
									...
									if(!$vendor_verified_label){
										$vendor_verified_label = '<div class="wcv-verified-vendor"><i class="fas fa-shield-check" aria-hidden="true"></i> '.__( 'Verified', 'rehub_framework' ).'</div>';
									}
								?>									
						...
						<div class="wcvendor_store_desc">
							...
							<div>
								<?php if($vendor_phone) : ?>
									<a href="tel:<?php echo $vendor_phone; ?>" class="mr5">
										<i class="fas fa-mobile-android-alt"></i> <?php echo $vendor_phone; ?>
									</a>
								<?php endif; ?>
								<?php if($vendor_email) : ?>								
			...
			<div class="rh-cartbox widget">
				<div>
					...
					<div class="profile-stats">
						<div><i class="far fa-user-circle"></i> <?php _e( 'Registration', 'rehub_framework' );  echo ': ' . date( get_option( "date_format" ), strtotime( $vendor->user_data->user_registered )); ?></div>
