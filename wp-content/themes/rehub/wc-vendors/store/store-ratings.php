				...
				<?php if ( $vendor_feedback ) { 
					...
					foreach ( $vendor_feedback as $vf ) {
						...
						<div class="wcv-rating-posted-by">
							<span><?php __( 'Posted on', 'rehub_framework'); ?> <?php echo $post_date; ?></span> <?php __( 'by', 'rehub_framework'); echo $customer_name; ?>
							<p><?php _e( 'Product:', 'rehub_framework'); ?><a href="<?php echo $product_link; ?>" target="_blank"><?php echo $product_title; ?></a></p>
						</div>
