        ...
        <aside class="sidebar authorsidebar">
            <div class="author_widget clearfix">
                ...
                <div class="profile-stats">
                    <div><i class="far fa-user"></i> <?php _e( 'Registration', 'rehub_framework' );  echo ': ' .date( get_option( "date_format" ), strtotime( $curauth->user_registered )); ?></div>
                    <div><i class="far fa-comment"></i><?php _e( 'Comments', 'rehub_framework' ); echo ': ' . $count_comments; ?></div>
                    <div><i class="fas fa-heartbeat"></i><?php _e( 'Votes', 'rehub_framework' ); echo ': ' . $count_p_votes; ?></div>
