			...
			<div class="rh-cartbox widget">
				<div>
					...
					<div class="profile-stats">
						<div><i class="far fa-user-circle"></i> <?php _e( 'Registration', 'rehub_framework' );  echo ': ' . date( get_option( "date_format" ), strtotime( $store_user->user_registered )); ?></div>
					...
					<div class="profile-description">
						<div>
							...
							<?php if ( $store_user->user_url ):?>
								<br />
								<i class="far fa-globe"></i> <a href="<?php echo esc_url( $store_user->user_url ); ?>" target="_blank" rel="nofollow"><?php echo $store_user->user_url; ?></a>
							<?php endif;?>
