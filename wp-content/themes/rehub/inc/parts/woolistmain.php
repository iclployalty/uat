...
<div class="news-community clearfix <?php echo rh_expired_or_not($post->ID, 'class');?> <?php echo implode(' ', $classes); ?>">
	...
	<div class="rh_grid_image_3_col">		
            ...
            <figure>
                <a href="<?php echo $woolink ;?>"<?php echo $wootarget ;?>>
                    ...
                    <?php 
                        ...
                        $height_figure_single = apply_filters( 're_woolistmain_height', 160 );
    	...
    	<div class="rh_gr_top_middle">
		    <h2 class="font120 mt0 mb10 mobfont110 lineheight20 moblineheight15 mr30 pr20 <?php echo getHotIconclass($post->ID, true); ?>"><a href="<?php echo $woolink ;?>"<?php echo $wootarget ;?>><?php the_title();?></a></h2>
        ...
        <div class="rh_gr_middle_desc">           
            ...
            <?php endif;?>                
    	    <div class="font90 mobfont70 lineheight20 moblineheight15 mb10"><?php kama_excerpt('maxchar=180'); ?></div>
        </div>
        <div class="rh_gr_middle_last mobilecenterdisplay">
            <div class="lineheight20"><?php wc_get_template( 'loop/rating.php' );?></div>  
        </div>                         
        <div class="rh_gr_btn_block">
            <div class="rehub-main-font mb10 pricefont130"><?php wc_get_template( 'loop/price.php' ); ?></div>
