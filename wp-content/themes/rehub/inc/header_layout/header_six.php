    ...
    <div class="rh-container">
        <div class="logo-section rh-flex-center-align tabletblockdisplay header_six_style clearfix">
            ...
            <?php if(rehub_option('header_six_src') == 1) : ?>
                <?php echo wpsm_searchform_shortcode(array('class'=>'head_search floatright hideontablet mr5 ml5 litesearchstyle'));?>
            <?php endif; ?>
            </div>                        
        </div>
    </div>
...
<!-- /Logo section -->  
<!-- Main Navigation -->
<div class="search-form-inheader main-nav<?php if (rehub_option('rehub_logo_inmenu') !='') {echo ' mob-logo-enabled';}?><?php if (rehub_option('rehub_sticky_nav') ==true){echo ' rh-stickme';}?><?php echo $header_menuline_style;?>">  
