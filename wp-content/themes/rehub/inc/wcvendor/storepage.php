	    			...
	    			<div class="wcvendor_store_desc">
					    <?php if ( class_exists( 'WCVendors_Pro' ) ) :?>
							...
							<?php if ($address) : ?>
								...
								<span class="rehub_scroll" data-scrollto="#wcvendors_pro_map_widget"><?php _e( '(Show on map)', 'rehub_framework' ); ?></span>
								<?php } ?>
							<?php endif; ?>
						<?php else: ?>
	    		...
	    		<div id="wcvendor_profile_act_btns" class="wcvendor_profile_cell">
				    ...
				    <?php if ( class_exists( 'BuddyPress' ) ) : ?>
						...
						<?php if ( bp_is_active('messages') && !$active_contact_widget ) { ?>
							...
							<a href="<?php echo esc_url($link); ?>" class="wpsm-button medium white<?php echo esc_attr($class); ?>"><?php _e('Contact vendor', 'rehub_framework'); ?></a>
						<?php } ?>
					<?php endif; ?>
					<?php if ( $active_contact_widget ) { ?>
						<span class="wpsm-button rehub_scroll medium white" data-scrollto="#wcv_pro_quick_contact_form"><?php _e( 'Contact vendor', 'rehub_framework' ); ?></span>
					<?php } ?>
	    		</div>	        			
			</div>
		</div>
			...
			<ul class="wcvendor_profile_menu_items">		
				...
				<?php if ( class_exists( 'WCVendors_Pro' ) ) :?>
					...
					<?php if ( $feedback_form_page ) :?>
						...
						<li><a href="<?php echo esc_url($url); ?>"><?php _e('Reviews', 'rehub_framework');?></a></li>	
					<?php endif;?>
				<?php endif;?>
	    ...
	    <aside class="rh-mini-sidebar user-profile-div floatleft tabletblockdisplay">
	    	<div class="rh-cartbox widget">
	            <div>
                    ...
                    <div><i class="far fa-user"></i> <?php _e( 'Registration', 'rehub_framework' );  echo ': ' .date( get_option( "date_format" ), strtotime( $vendor->user_registered )); ?></div>
	                    <div><i class="far fa-heartbeat"></i><?php _e( 'Product Votes', 'rehub_framework' ); echo ': ' . $count_p_votes; ?></div>
					...
					<?php if ( class_exists( 'WCVendors_Pro' ) ) : ?>
						<div class="profile-description">
							<div>
								<span><?php _e( 'Contact', 'rehub_framework' ); ?></span>
								<p>
								<?php if( !$active_address_and_map ) : ?>
	        ...
	        <?php endif;?>
			<?php if( !is_active_widget( '', '', 'wcv_store_categories' ) ) : ?>
	    	<div class="rh-cartbox widget">
	            <div>
					...
					<ul class="category-vendormenu">
					    ...
					    <?php $liclass = ($cat_string == $category->ID) ? 'current' : '';?>
					    <li class="<?php echo esc_attr($liclass); ?>">
					    	<?php
					    		...
					    		wp_reset_query();
					    	?>
					        <a href="<?php echo esc_url($shop_url); ?>?rh_wcv_vendor_cat=<?php echo esc_attr($category->ID); ?>" title="<?php echo esc_attr($category->name); ?>">
					            <?php echo esc_html($category->name) .'<span>'.$count.'</span> '; ?>
					        </a>
					    </li>
					    <?php endforeach; ?>
					</ul>
